...
export default function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex md:flex-col md:w-64 lg:w-72 bg-brand-surface text-brand-text shrink-0 fixed left-0 top-0 bottom-0 z-20 border-r border-brand-border/50">
        {/* Sidebar header */}
        ...
        <div className="p-3 border-t border-brand-border/50 space-y-1">
          <button onClick={() => navigate('/onboarding')}
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-brand-muted hover:bg-brand-surface-alt hover:text-brand-text w-full transition-colors">
